      ...
      <>
        <CardContent className="flex flex-col gap-4">
          <p className="text-[14.5px] leading-relaxed text-foreground">
            Added. Give each person their temporary password now — this is the
            only time it is shown, and they can change it once they sign in.
          </p>
          <ul className="flex flex-col gap-2">
            {invited.map((person) => (
              ...
              >
                ...
                <code className="select-all rounded-sm bg-surface px-2.5 py-1.5 font-mono text-[13px] font-semibold text-foreground">
                  {person.password}
                </code>
              </li>
            ))}
        ...
        <CardFooter>
          <Button onClick={onDone}>
            Got them written down <ArrowRight />
          </Button>
        </CardFooter>
      </>
    );
