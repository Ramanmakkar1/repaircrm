 ...
 *
 * A NEW lead under a day old gets a solid accent bar down its left edge — the
 * cheapest possible "this is still warm, call them" signal, and it disappears
 * on its own once the lead is answered or goes cold. Everything else on the
 * card is grey so that bar and the status chip are the only colour.
 */
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        fresh && "border-l-4 border-l-accent pl-[17px]",
      )}
    >
