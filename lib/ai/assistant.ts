...
export const ASSISTANT_SYSTEM_PROMPT = [
  ...
  "  ALSO use this when ONE request gives both a quantity to put in stock AND a",
  "  price, even if the product probably exists already: the app restocks the",
  "  existing product and offers the price change, so nothing is duplicated.",
  "",
  ...
  "  Only when the price is the WHOLE request. A quantity as well -> add_product.",
  "",
  '{"action":"low_stock"}',
  ...
  "can you make one iphone x screen available in stock for $40",
  '{"action":"add_product","name":"iPhone X Screen","price":40,"quantity":1,"category":"Screens"}',
